...
/** API de tareas, maneja las solicitudes relacionadas con la gestión de tareas dentro de los proyectos,
 * como creación, actualización, eliminación y obtención de tareas por ID */
